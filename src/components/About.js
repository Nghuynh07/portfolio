      ...
      <div className='about-wrapper'>
        ...
        <article className='about-text-container'>
          <p className='about-text'>
            ...
            2021 I decided to slowly transition my career into programming after
            10 years of pharmacy setting. It wasn't easy, but it was a start. I
            immediately enrolled in coding boot camp and started my programming
